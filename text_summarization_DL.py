...
data = pd.read_csv("C:/Users/7325598/Desktop/tensorflow practice/18_2157_bundle_archive/Reviews.csv", encoding='utf8', nrows = 10000)
...
#Attention Layer
attn_out, attn_states = AttentionLayer(name='attention_layer')([encoder_output, decoder_outputs]) 
